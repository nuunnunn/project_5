...
,'라스트 젤리 샷','눈에 갇힌 외딴 산장에서','낙원은 창백한 손으로', '저주 토끼','자연에 이름 붙이기' ,    
'삶은 언제나 답을 찾는다'];
// var search = ['칵테일, 러브, 좀비', '코리아이'];
...
'모든 삶은 흐른다','메리골드 마음 세탁소','불편한 편의점2','해가 지는 곳으로','레슨 인 케미스트리 1',  
...
//best - all
var search14 = ['도시와 그 불확실한 벽','로터스 택시에는 특별한 손님이 탑니다', '어서 오세요, 휴남동 서점입니다',
...
//section7
var search10 = ['착취도시, 서울', '못생긴 서울을 걷는다', '동자동, 당신이 살 권리', '갈등 도시', 
'우리는 어디서 살아야 하는가', '나의 이상하고 평범한 부동산 가족'];
